...
function showRespawnButton(victimDropItem)
	...
	bRespawn = guiCreateButton(x, y, width, height,"Respawnear",false)
...
function getMedicalBill(amount, insurance, faction, issuedBy, date, rankName)
	...
	medicalBillWindow = guiCreateWindow(x, y, width, height, "Factura médica", false)
		guiWindowSetSizable(medicalBillWindow, false)

	if faction == 164 then
		local logo = guiCreateStaticImage(24, 20, 111, 73, "ash.png", false, medicalBillWindow)

		local label5 = guiCreateLabel(20, 103, 140, 22, "Cobrar a:", false, medicalBillWindow)
		...
		local label7 = guiCreateLabel(20, 147, 140, 22, "Pagar a:", false, medicalBillWindow)
		...
		local label9 = guiCreateLabel(20, 191, 140, 22, "Expedido por:", false, medicalBillWindow)
		...
		local label11 = guiCreateLabel(20, 252, 140, 22, "Fecha de emisión:", false, medicalBillWindow)
		...
		local label5 = guiCreateLabel(20, 30, 140, 22, "Cobrar a:", false, medicalBillWindow)
			guiSetFont(label5, "default-bold-small")

		local label6 = guiCreateLabel(20, 52, 140, 22, exports.global:getPlayerName(localPlayer), false, medicalBillWindow)
			guiSetFont(label6, "default-small")

		local label7 = guiCreateLabel(20, 74, 140, 22, "Pagar a:", false, medicalBillWindow)
			guiSetFont(label7, "default-bold-small")

		local label8 = guiCreateLabel(20, 96, 140, 22, exports.factions:getFactionName(faction), false, medicalBillWindow)
			guiSetFont(label8, "default-small")

		local label9 = guiCreateLabel(20, 118, 140, 22, "Expedido por:", false, medicalBillWindow)
			guiSetFont(label9, "default-bold-small")
		...
		local label11 = guiCreateLabel(20, 184, 140, 22, "Fecha de emisión:", false, medicalBillWindow)
			guiSetFont(label11, "default-bold-small")
	...
	if bg then
		local label1 = guiCreateLabel(40, 5, 170, 22, "FACTURA MÉDICA", false, bg)
			guiSetFont(label1, "default-bold-small")
			guiLabelSetColor(label1, 0, 0, 0)

		local label2 = guiCreateLabel(40, 37, 170, 22, "Tarifas totales: $ "..tostring(exports.global:formatMoney(amount)), false, bg)
			guiLabelSetColor(label2, 170, 0, 0)
			local label2_2 = guiCreateLabel(18, 32, 22, 22, "", false, bg)
				guiLabelSetColor(label2_2, 0, 0, 0)

		local label3 = guiCreateLabel(40, 54, 170, 22, "Seguro: $ "..tostring(exports.global:formatMoney(insurance)), false, bg)
		...
		local label4 = guiCreateLabel(40, 76, 170, 22, "TOTAL DEBIDO: $ "..tostring(exports.global:formatMoney(amount-insurance)), false, bg)
			guiSetFont(label4, "default-bold-small")
			guiLabelSetColor(label4, 170, 0, 0)
			local label3_2 = guiCreateLabel(18, 76, 22, 22, "=", false, bg)
				guiLabelSetColor(label3_2, 0, 0, 0)
	else
		local label1 = guiCreateLabel(200, 30, 170, 22, "FACTURA MÉDICA", false, medicalBillWindow)
			guiSetFont(label1, "default-bold-small")

		local label2 = guiCreateLabel(200, 62, 170, 22, "Tarifas totales: $ "..tostring(exports.global:formatMoney(amount)), false, medicalBillWindow)

		local label3 = guiCreateLabel(200, 84, 170, 22, "Seguro: - $ "..tostring(exports.global:formatMoney(insurance)), false, medicalBillWindow)

		local label4 = guiCreateLabel(200, 106, 170, 22, "TOTAL ADECUADO: $ "..tostring(exports.global:formatMoney(amount-insurance)), false, medicalBillWindow)
			guiSetFont(label4, "default-bold-small")
	end

	b1 = guiCreateButton(160, 138, 210, 40, "Pagar en efectivo", false, medicalBillWindow)
	...
	b2 = guiCreateButton(160, 188, 210, 40, "Pagar por banco", false, medicalBillWindow)
	...
	b3 = guiCreateButton(160, 238, 210, 40, "Negarse a pagar", false, medicalBillWindow)
	addEventHandler("onClientGUIClick", b3, function()
		closeMedicalBillWindow()
		outputChatBox("Te negaste a pagar la factura médica.", 255, 0, 0)

...
function displayOneMotd()
    ...
    if pointer and motds and #motds>0 and motds[pointer] then
        ...
        GUIEditor.window[1] = guiCreateWindow(491, 193, 800, 369, "Mensaje del Dia! - "..motds[pointer].title, false)
        ...
        GUIEditor.label[1] = guiCreateLabel(10, 330, 329, 16, "Por "..motds[pointer].author, false, GUIEditor.window[1])
        ...
        GUIEditor.button[1] = guiCreateButton(666, 330, 124, 29, "Cerrar", false, GUIEditor.window[1])
        GUIEditor.checkbox[1] = guiCreateCheckBox(522, 335, 144, 14, "No mostrar de nuevo", false, false, GUIEditor.window[1])

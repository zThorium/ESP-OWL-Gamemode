...
function showSettingsWindow(tab)
	...
	GUIEditor_Window.main = guiCreateWindow(x,y,w,h,"Ajustes",false)
	...
	GUIEditor_Label.graphicSettingsgeneral = guiCreateLabel(0.0222,0.0361,0.313,lineH,"Configuración General:",true,GUIEditor_Tab.graphicSettings)
	guiSetFont(GUIEditor_Label.graphicSettingsgeneral,"default-bold-small")

	GUIEditor_Checkbox.graphic_motionblur = guiCreateCheckBox(0.036,0.1005,0.2992,lineH,"Activar Desenfoque",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_skyclouds = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Activar Nubes",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.streams = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Habilitar la transmisión de audio",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_logs = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Habilitar el registro de clientes del chatbox",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.cellphone_log = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Habilitar el registro de llamadas y SMS del cliente",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_chatbub = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Habilitar burbujas de chat",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_chatbub_square = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Habilitar cuadrados de burbujas de chat",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_typingicon = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Habilitar iconos de escritura",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("chat-system") then
	...
	GUIEditor_Checkbox.graphic_nametags = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Activar nametags",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.settings_hud_style = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Habilitar nuevo estilo de HUD",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("hud") then
	...
	GUIEditor_Checkbox.graphic_shaderradar = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Habilitar sombreador de radar",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_shaderwater = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Habilitar sombreador de agua",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_shaderveh = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Habilitar sombreador de vehículos",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.vehicle_hotkey = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Habilitar teclas de acceso rápido de control de vehículos",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.autopark = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Activar Vehiculo auto /park",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName('vehicle') then
	...
	GUIEditor_Checkbox.vehicle_rims = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Habilitar modelos de llanta personalizados",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.phone_anim = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Habilitar animación del teléfono",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.talk_anim = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Habilitar animaciones /say",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.pm_username = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Muestra tu nombre de usuario /pm.",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.weapon_show_selector = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Mostrar selector de armas mientras disparas.",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.bind_indicators = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Habilitar indicadores reenlazables.",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.dynamic_lighting = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Habilitar iluminación dinámica.",false,true,GUIEditor_Tab.graphicSettings)
	...
	if groundsnow then
		posY = posY + lineH
		GUIEditor_Checkbox.groundsnow = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Habilitar nieve en el suelo.",false,true,GUIEditor_Tab.graphicSettings)
	...
	if snowfall then
		posY = posY + lineH
		GUIEditor_Checkbox.snowfall = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Habilitar nevadas.",false,true,GUIEditor_Tab.graphicSettings)
	...
	if xmas then
		posY = posY + lineH
		GUIEditor_Checkbox.xmastreefx = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Habilitar efectos de árbol de Navidad.",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.punishment_notification_selector = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Ocultar notificaciones de castigo del administrador.",false,true,GUIEditor_Tab.graphicSettings)
	...
	if exports.integration:isPlayerSupporter(getLocalPlayer()) or exports.integration:isPlayerTrialAdmin(getLocalPlayer()) then
		posY = posY + lineH
		GUIEditor_Checkbox.auto_check = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Abrir automáticamente /check /ar",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.enableNewUIStyle = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Habilitar nuevo estilo GUI",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("hud") then
	...
	if exports.integration:isPlayerStaff(localPlayer) then
		posY = posY + lineH
		GUIEditor_Checkbox.enableIncomingReport = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Habilitar sonidos en informes entrantes",false,true,GUIEditor_Tab.graphicSettings)
		...
		posY = posY + lineH
		GUIEditor_Checkbox.enableIncomingPriorityReport = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Habilitar sonidos en informes de prioridad entrantes",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.misc_sounds = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Deshabilitar sonidos varios predeterminados del juego",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.vehicle_discs = guiCreateCheckBox(0.0222+posX,posY,0.413,lineH,"Ocultar la descripción actual del vehículo con ALTGR",false,true,GUIEditor_Tab.graphicSettings)
	...
	posX = posX + lineW2
	GUIEditor_Label.graphicSettings_desc = guiCreateLabel(0.0222+posX,0.0361,0.313,lineH,"Descripción Configuraciones de superposición:",true,GUIEditor_Tab.graphicSettings)
	guiSetFont(GUIEditor_Label.graphicSettings_desc,"default-bold-small")

	GUIEditor_Checkbox.enableOverlayDescription = guiCreateCheckBox(0.036+posX,0.1005,0.2992,lineH,"Alternar toda la descripción superpuesta",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.enableOverlayDescriptionVeh = guiCreateCheckBox(0.036+posX,0.1005+lineH,0.2992,lineH,"Vehículo: Habilitar descripción",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("description") then
	...
	GUIEditor_Checkbox.enableOverlayDescriptionPro = guiCreateCheckBox(0.036+posX,0.1005+lineH*3,0.2992,lineH,"Interior: Habilitar descripción",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("description") then
	...
	GUIEditor_Checkbox.enableOverlayDescriptionNote = guiCreateCheckBox(0.036+posX,0.1005+lineH*5,0.2992,lineH,"Notas: Habilitar descripción",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("description") then
	...
	GUIEditor_Label.graphicSettingsgeneral = guiCreateLabel(0.0222,0.0361,0.313,lineH,"Recibir notificaciones sobre:",true,GUIEditor_Tab.Notifications)
	guiSetFont(GUIEditor_Label.graphicSettingsgeneral,"default-bold-small")

	GUIEditor_Checkbox.noti_faction_updates = guiCreateCheckBox(0.036,0.1005,0.2992,lineH,"Actualizaciones de facciones",false,true,GUIEditor_Tab.Notifications)
	guiCheckBoxSetSelected(GUIEditor_Checkbox.noti_faction_updates,getElementData(localPlayer, "noti_faction_updates") ~= "0")

	GUIEditor_Checkbox.noti_offline_pm = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Mensajes entrantes sin conexión",false,true,GUIEditor_Tab.Notifications)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.interior_inactivity_scanner = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Relacionado con el interior",false,true,GUIEditor_Tab.Notifications)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.support_center = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Centro de Soporte",false,true,GUIEditor_Tab.Notifications)
	guiCheckBoxSetSelected(GUIEditor_Checkbox.support_center,getElementData(localPlayer, "support_center") ~= "0")

	local lineW2 = 0.34
	local posX = lineW2
	posY = 0.1005
	GUIEditor_Label.graphicSettingsgeneral = guiCreateLabel(0.0222+posX,0.0361,0.313,lineH,"Configuración general:",true,GUIEditor_Tab.Notifications)
	guiSetFont(GUIEditor_Label.graphicSettingsgeneral,"default-bold-small")

	GUIEditor_Checkbox.noti_no_noti = guiCreateCheckBox(0.036+posX,0.1005,1,lineH,"Mostrar botón incluso cuando no hay notificaciones",false,true,GUIEditor_Tab.Notifications)
	...
	GUIEditor_Label.graphicSettingsgeneral = guiCreateLabel(0.0222,0.0361,0.313,lineH,"Lista de Amigos:",true,GUIEditor_Tab.Social)
	guiSetFont(GUIEditor_Label.graphicSettingsgeneral,"default-bold-small")

	GUIEditor_Checkbox.social_classic_user_interface = guiCreateCheckBox(0.036,0.1005,0.888,lineH,"Interfaz de usuario clásica",false,true,GUIEditor_Tab.Social)
	...
	GUIEditor_Checkbox.social_invite_only = guiCreateCheckBox(0.036,0.1005+posY,0.888,lineH,"Sólo por invitación (ignorar todas las solicitudes de amistad entrantes)",false,true,GUIEditor_Tab.Social)
	guiCheckBoxSetSelected(GUIEditor_Checkbox.social_invite_only,getElementData(localPlayer, "social_invite_only") == "1")

	posY = posY + lineH
	GUIEditor_Checkbox.social_friends_bypass_pmblock = guiCreateCheckBox(0.036,0.1005+posY,0.888,lineH,"Permitir a mis amigos evitar mi bloque PM",false,true,GUIEditor_Tab.Social)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.social_friend_updates = guiCreateCheckBox(0.036,0.1005+posY,0.888,lineH,"Reciba alertas y notificaciones de amigos",false,true,GUIEditor_Tab.Social)
	guiCheckBoxSetSelected(GUIEditor_Checkbox.social_friend_updates,getElementData(localPlayer, "social_friend_updates") ~= "0")

	posY = posY + lineH
	local indent = 0.02
	GUIEditor_Checkbox.social_friend_updates_on_off = guiCreateCheckBox(0.036+indent,0.1005+posY,0.888,lineH,"Online/offline Estado",false,true,GUIEditor_Tab.Social)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.social_friend_updates_msg = guiCreateCheckBox(0.036+indent,0.1005+posY,0.888,lineH,"Mensajes de estado",false,true,GUIEditor_Tab.Social)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.social_friend_updates_char = guiCreateCheckBox(0.036+indent,0.1005+posY,0.888,lineH,"Cambios de personaje",false,true,GUIEditor_Tab.Social)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.social_friend_updates_sound = guiCreateCheckBox(0.036+indent,0.1005+posY,0.888,lineH,"Habilitar efecto de sonido",false,true,GUIEditor_Tab.Social)
	...
	GUIEditor_Button.mainclose = guiCreateButton(0.0135,0.9135,0.9743,0.0675,"Cerrar",true,GUIEditor_Window.main)
